...
return {
	X: {
		PAGES: ["pàgines", "1 pàgina", "Cap pàgina"],
		PICTURES: ["imatges", "1 imatge", "Cap imatge"],
		SONGS: ["cançons", "1 cançó", "Cap cançó"],
		BOOKMARKS: ["marcadors", "1 marcador", "Cap marcador"],
		COLLECTIONS: ["col·leccions", "1 col·lecció", "Cap col·lecció"],
		ITEMS: ["elements", "1 element", "Cap element"]
	},

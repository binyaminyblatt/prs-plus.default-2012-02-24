...
var FUNC_X_SETTINGS = function (n) {
        return FUNC_X_SOMETHING(n, ["paramčtres", "1 paramčtres", "Aucun paramčtres"]);
};

var FUNC_X_ITEMS = function (n) {
        return FUNC_X_SOMETHING(n, ["éléments", "1 élément", "Aucun paramčtres"]);
};
...
return {
        ...
        Sony: {
                ...
                HR_WARNING: "Vous voulez effacer tout le contenu et restaurer les paramčtres initiaux et le paramčtrage des verroux numeriques?\n\nOui - Touche 5\nAucun - Touch MENU",
                ...
                RESTORE_DEFAULTS: "Restaurer les paramčtres par défaut",
                PRESS_MARK_TO_RESTORE: "Appuyer sur SIGNET pour restaurer",
                DEFAULT_SETTINGS: "les paramčtres par défaut.",
                UPPER_PAGE: "PAGE",
                ONE_OF_ONE: "1 de 1",
                ...
                AS_OK_SIZE: 2,
                // about
                ABOUT: "Ŕ propos de Reader",
                // reset to factory settings
                RESET_TO_FACTORY: "Restaurer les paramčtres par défaut",


                // In Advanced Settings
                ADVANCED_SETTINGS: "Paramčtres avancés",
        ...
        KeyBindings: {
                ...
                BN_SIZE: "Zoom",
                BN_BOOKMARK: "Signet",
                BN_BL_NEXT: "'Page suivante' ŕ gauche",
                BN_BL_PREVIOUS: "'Page précédente' ŕ gauche",
                ...
                BN_H_BL_NEXT:     "Maintenir 'Page suivante' ŕ gauche",
                BN_H_BL_PREVIOUS: "Maintenir 'Page précédente' ŕ gauche",
        ...
        BrowseFolders: {
                ...
                NODE_COPY_TO_INTERNAL_MEMORY_COMMENT: "Copie de fichiers ŕ la racine de la mémoire interne",
                NODE_COPY_AND_RESCAN: "Copie & Rescan mémoire interne",
                NODE_COPY_AND_RESCAN_COMMENT: "Copie de fichiers ŕ la racine de la mémoire interne et rescan",
                ERROR_TARGET_EXISTS: "Erreur, le fichier existe",
                NODE_BROWSE_FOLDERS: "Parcourir les dossiers",
                NODE_BROWSE_FOLDERS_COMMENT: "Parcourir le systčme de fichiers",
